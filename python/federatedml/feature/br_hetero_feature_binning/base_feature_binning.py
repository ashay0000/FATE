...
from federatedml.transfer_variable.transfer_class.br_hetero_feature_binning_transfer_variable import \
    BrHeteroFeatureBinningTransferVariable  # 修改内容
...
class BaseHeteroFeatureBinning(ModelBase):
    ...
    def __init__(self):
        ...
        self.transfer_variable = BrHeteroFeatureBinningTransferVariable()
